...
@section('content')
  <div class="content-block content-block_register">
    <form action="{{ route('user') }}" method="POST" class="form" id="form-user-register">
      @csrf
      <input type="hidden" name="action" value="register">

      <div class="form__row">
        <label for="form-user-register-login" class="form__label">Your email will be your login on website</label>
        <input id="form-user-register-login" type="email" name="email" class="form__input" placeholder="Enter your e-mail" required>
      </div>
      ...
      <div class="form__row">
        ...
        <input id="form-user-register-name" type="text" name="name" class="form__input" placeholder="Enter your name" required>
      </div>
